<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZAgentWinAndLose.aspx.cs" Inherits="agent.Report.ZAgentWinAndLose" %>
        ...
        function getUserName(data) {
            jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/GetUserName", data, true, false, function (json) {
                ...
                jQuery.each(result, function (i) {
                    ...
                    tr.find("#Percentes").html(parseFloat(result[i].ZAgentPercent * 100).toFixed(2) + " %<br/>" + parseFloat(result[i].AgentPercent * 100).toFixed(2) + " %");
...
<%--    <th>股東</th>
    ...
    <th rowspan="2"><span id="H1419">总代占成</span><br /><span id="H1420">代理占成</span></th>
    <th rowspan="2">IP</th>
    </tr>
    <tr>
