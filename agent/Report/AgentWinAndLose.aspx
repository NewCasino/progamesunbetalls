<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentWinAndLose.aspx.cs" Inherits="agent.Report.AgentWinAndLose" %>
        ...
        function getUserName(data) {
            jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/GetUserName", data, true, false, function (json) {
                ...
                jQuery.each(result, function (i) {
                    ...
                    tr.find("#Percentes").html(parseFloat(result[i].AgentPercent * 100).toFixed(2) + " %");
