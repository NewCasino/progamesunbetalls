<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinAndLoseSimple.aspx.cs" Inherits="agent.Report.WinAndLoseSimple" %>
...
//             f.find("#Id").text("帳號");
//             f.find("#Shift").text("移交");
//             f.find("#Effective").text("有效投注");
//             f.find("#Money").text("付款");
//             f.find("#Profit").text("分公司贏利");
//             f.find("#Commison").text("分公司傭金");
//             f.find("#Total").text("分公司合計");
//             f.find("#Company").text("公司");
//             f.appendTo("#Tbody1");
             if (roleId == 2) {
                 var f;
                 f = jQuery("#Title").clone();
         ...
         function getUserName(data) {
             jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/GetUserName", data, true, false, function (json) {
                 ...
                 jQuery.each(result, function (i) {
                     ...
                     tr.find("#Information").html(result[i].UserName + "<br/>" + languages.H1414 + "<br/>" + time);
