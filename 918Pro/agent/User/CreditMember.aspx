<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditMember.aspx.cs" Inherits="agent.User.CreditMember" %>
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st"> <span id="yyye">信用与户口余额</span></font><a onmouseover="this.style.cursor='hand'"></a></p></th>
