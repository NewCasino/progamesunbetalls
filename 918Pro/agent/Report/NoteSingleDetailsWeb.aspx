<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoteSingleDetailsWeb.aspx.cs" Inherits="agent.Report.NoteSingleDetailsWeb" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        SetGlobal("");
            ...
            //var data = "length:'50',league:'',level:'0',type:
            getCasino();
...
//                jQuery("#level>option:eq(5)").text(languages["H1261"]+"1");
                ...
                jQuery("#tb2>thead>tr>th:eq(4)").text(languages["H1171"]);
                jQuery("#tb2>thead>tr>th:eq(5)").text(languages["H1172"]);
                jQuery("#tb2>thead>tr>th:eq(6)").text(languages["H1263"]);
                jQuery("#tb2>thead>tr>th:eq(7)").text(languages["H1054"]);
            }, "/js/IndexGlobal/");
                switch (setLang) {
            ...
            jQuery.AjaxCommon("/ServicesFile/ReportService/NoteSingleService.asmx/GetAllTolength", data, true, false, function (json) {
                if (json.d != "none") {
                    ...
                    jQuery.each(result, function (i) {
                        ...
                        arr.push(typeList[parseInt(result[i].BetType)] + "&nbsp;&nbsp;&nbsp;&nbsp;" + (result[i].IsHalf == 1 ? languages["H1159"] : languages["H1160"]) + "<br/>" + result[i].BetItem);
                        arr.push("</td>");

                        arr.push("<td id='Handicap'>");
                        arr.push(result[i].Handicap + "<br/>" + result[i].Odds + "<br/>" + result[i].OddsType);
                        arr.push("</td>");
...
<input type="hidden" id="language" value="tw" />
    ...
    <% if (searchAc)
       { %>
<div class="fl">
<input id="leagueAll" type="button" value="选择联赛" />&nbsp;&nbsp;    <input type="button" id="boll" value="选择球队" />&nbsp;&nbsp;
    ...
    <option value="0">全部</option><option value="5">普通</option>
    <option value="4">常赢4</option><option value="3">常赢3</option>
    <option value="2">常赢2</option><option value="1">常赢1</option>
    </select>&nbsp;&nbsp;
...
<input type="text" id="timeTxt" value="5" class="text_01 w_30" onmouseover="this.className='text_01_h w_30'" onmouseout="this.className='text_01 w_30'" /><label id="timeUp">5</label>&nbsp;&nbsp;&nbsp;
    <input type="text" value="50" id="DataLength" class="text_01 w_30" onmouseover="this.className='text_01_h w_30'" onmouseout="this.className='text_01 w_30'" /><a id="tjl">条记录</a>
</div>
