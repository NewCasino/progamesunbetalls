<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="StandardWeb.aspx.cs" Inherits="agent.Report.StandardWeb" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            var data = "language:'" + jQuery("#language").val() + "',league:'',gameId:'',limi:'" + jQuery("#DataLength").val() + "'";
            setData(data);
            ...
            jQuery("#selectByWhere").click(function () {
                ...
                var data = "language:'" + jQuery("#language").val() + "',league:'" + leagueName + "',gameId:'" + bollID + "',limi:'" + jQuery("#DataLength").val() + "'";
                setData(data);
            });
        })
        ...
        function SetGlobal(setLang) {
            setLang = $.SetOrGetLanguage(setLang, function () {
                ...
                jQuery("#tab2>thead>tr:eq(0)").find("th:eq(0)").text(languages["H1056"]);
                jQuery("#tab2>thead>tr:eq(0)").find("th:eq(1)").text(languages["H1266"]);
                jQuery("#tab2>thead>tr:eq(0)").find("th:eq(2)").text(languages["H1159"]);
                jQuery("#tab2>thead>tr:eq(0)").find("th:eq(3)").text(languages["H1281"]);
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(0)").text("1");
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(1)").text("X");
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(2)").text("2");
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(3)").text(languages["H1487"]);
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(4)").text("1");
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(5)").text("X");
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(6)").text("2");
                jQuery("#tab2>thead>tr:eq(1)").find("th:eq(7)").text(languages["H1488"]);
        ...
        function setData(data) {
            var url = "/ServicesFile/ReportService/NoteSingleService.asmx/Get1x2";
                ...
                if (json.d != "none") {
                    ...
                    jQuery.each(result, function (i) {
                        ...
                        if (jQuery("#language").val() == "tw") {
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html((result[i].betflag == "H" ? result[i].Hometw : (result[i].betflag == "A" ? result[i].Awaytw : "X")) + "<br/>" + (type.length == 1 ? languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1157"] : languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1279"]) + "<br/>" + result[i].Hometw + "&nbsp;-VS-&nbsp;" + result[i].Awaytw + "<br/>" + result[i].leaguetw + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html((result[i].betflag == "H" ? result[i].Homecn : (result[i].betflag == "A" ? result[i].Awaycn : "X")) + "<br/>" + (type.length == 1 ? languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1157"] : languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1279"]) + "<br/>" + result[i].Homecn + "&nbsp;-VS-&nbsp;" + result[i].Awaycn + "<br/>" + result[i].leaguecn + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html((result[i].betflag == "H" ? result[i].Homeen : (result[i].betflag == "A" ? result[i].Awayen : "X")) + "<br/>" + (type.length == 1 ? languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1157"] : languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1279"]) + "<br/>" + result[i].Homeen + "&nbsp;-VS-&nbsp;" + result[i].Awayen + "<br/>" + result[i].leagueen + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html((result[i].betflag == "H" ? result[i].Hometh : (result[i].betflag == "A" ? result[i].Awayth : "X")) + "<br/>" + (type.length == 1 ? languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1157"] : languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1279"]) + "<br/>" + result[i].Hometh + "&nbsp;-VS-&nbsp;" + result[i].Awayth + "<br/>" + result[i].leagueth + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html((result[i].betflag == "H" ? result[i].Homevn : (result[i].betflag == "A" ? result[i].Awayvn : "X")) + "<br/>" + (type.length == 1 ? languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1157"] : languages["H1159"] + "&nbsp;&nbsp;&nbsp;" + languages["H1279"]) + "<br/>" + result[i].Homevn + "&nbsp;-VS-&nbsp;" + result[i].Awayvn + "<br/>" + result[i].leaguevn + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                        
                        tr.find("#Odds").html("" + result[i].Odds);
                        tr.find("#AmountTD").html("" + result[i].Amount + "<br/>" + result[i].ValidAmount);
                        var setLang = "";
                        setLang = $.SetOrGetLanguage(setLang, function () {
                            languages = language;
