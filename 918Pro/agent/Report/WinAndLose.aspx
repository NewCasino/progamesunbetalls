<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinAndLose.aspx.cs" Inherits="agent.Report.WinAndLose" %>
        ...
        function setData(data) {
            jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/GetMatch2", data, true, false, function (json) {
                ...
                jQuery.each(result, function (i) {
                    ...
                    //输赢
                    tr.find("#winandlose").html(result[i].winlose);
                    ...
                    totalwinandlose += parseFloat(result[i].winlose);
                ...
                tr.find("td:eq(7)").html((totalwinandlose).toFixed(2));
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st"> <span id="H1412">会员详细</span>：</font></p></th>
