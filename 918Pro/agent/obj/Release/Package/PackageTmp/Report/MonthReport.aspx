<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthReport.aspx.cs" Inherits="agent.Report.MonthReport" %>
        ...
        function setData(data) {
            jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/GetMatch3", data, true, false, function (json) {
                ...
                jQuery.each(result, function (i) {
                    ...
                    tr.find("#winandlose").html(result[i].winandlose);
                    ...
                    totyjinamount += parseFloat(yjinamount);
                    tr.appendTo("#showInfo");
                });
                ...
                tr.find("td:eq(8)").html((totyjinamount).toFixed(2));
