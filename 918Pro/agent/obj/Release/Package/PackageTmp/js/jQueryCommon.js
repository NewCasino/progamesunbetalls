...
function ShowTipDiv(timeout) {
    ...
    if ($("#datagrid-mask").length == 0) {
        ...
        $("<div id=\"datagrid-mask-msg\" style=\"position:absolute;\"></div>").html("<img src='/images/loading.gif'/>").appendTo("body").css({ display: "none", left: ($(window).width() - 16) / 2 + 'px', top: ($(window).height() - 160) / 2 + 'px' });
    }
