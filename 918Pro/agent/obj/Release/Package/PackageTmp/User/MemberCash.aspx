<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberCash.aspx.cs" Inherits="agent.User.MemberCash" %>
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st" id="hyqd"> 会员清单</font>：<a onmouseover="this.style.cursor='hand'" onclick="getCount1(0,0,'','2','0',0,0,0)"><span id="sy"> 首页</span></a></p></th>
