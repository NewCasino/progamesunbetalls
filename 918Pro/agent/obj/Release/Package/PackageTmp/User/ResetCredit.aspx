<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetCredit.aspx.cs" Inherits="agent.User.ResetCredit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SetGlobal(setLang) {
            ...
            setZM();
            //getpage();
            getCount("<% =UserName %>","<% =RoleId %>",<% =Percent %>,<% =CommissionA %>,<% =CommissionB %>,<% =CommissionC %>,<% =ID %>);
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st"> <span id="czhyxy">重置会员信用</span></font><a onmouseover="this.style.cursor='hand'" ></a></p></th>
