<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Credit.aspx.cs" Inherits="agent.User.Credit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getpage() {
            ...
            jQuery.AjaxCommon("/ServicesFile/UserService.asmx/GetAgentsAcount", data, false, false, function (json) {
                var count = 0;
                if (json.d != "none") {
                    count1 = json.d;
...
//            perC = pc;
       ...
       function selectUserMinCredit(id){
           var data = "upId:" + id;
            jQuery.AjaxCommon("/ServicesFile/ConfigService.asmx/GetUserMinCredit", data, false, false, function (json) {
                if (json.d != "none") {
                    var count = 0;
                    var result = jQuery.parseJSON(json.d);
                    jQuery.each(result, function (i) {
        ...
        function selectMaxCredit(userId) {
            ...
            jQuery.AjaxCommon("/ServicesFile/ConfigService.asmx/GetMaxCredit", data, false, false, function (json) {
                if (json.d != "none") {
                    ...
                    var result = jQuery.parseJSON(json.d);
                    jQuery.each(result, function (i) {
                        maxCredit = parseFloat(result[i].Credit).toFixed(2);
                    });
                }
            });
        }
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st"> <span id="H1451">信用</span>：</font><a onmouseover="this.style.cursor='hand'"></a></p></th>
