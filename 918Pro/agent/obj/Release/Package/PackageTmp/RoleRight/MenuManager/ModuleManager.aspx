<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleManager.aspx.cs" EnableViewState="false" Inherits="agent.RoleRight.MenuManager.ModuleManager" %>
...
<th width="*" class="tab_top_m"><p>模块管理</p></th>
...
<input type="button" id="Button1" onclick="window.location='ModuleOperate.aspx'" class="top_add" onmouseover="this.className='top_add_h'" onmouseout="this.className='top_add'"  value="模块操作管理" />
</div>
        ...
        <div class="head"><div class="head-right"></div></div>
            <div class="main">
                <table width="100%" cellpadding="5" >
                    ...
                    <tr>
                        <td align="right" width="130px">选择模块:</td>
