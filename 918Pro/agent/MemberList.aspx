<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberList.aspx.cs" Inherits="agent.MemberList" %>
...
<head>
    ...
    <link href="/css/Default/cupertino/jquery-ui-1.8.2.custom.css" rel="stylesheet" type="text/css" />
        ...
        var per_page_number = 25;    //每页显示记录数
        var zm = "";
        //var percet = 0;
        //var commission = 0;
        var pd = 0;
        ...
        /*--------------查询方法------------------------------*/
        var tr1;
        function setDate(pages) {
            <% if(searchAc) { %>
            var data = "moneyType:'1',upUserName:'" + upUserName + "',userName:'" + jQuery("#UserName").val() + "',status:'" + jQuery("#stateSlt").val() + "',limitStart:" + pages*per_page_number + ",limitEnd:" + per_page_number + ",roleId:" + roleId;
            <% } else { %>
            var data = "moneyType:'1',upUserName:'" + upUserName + "',userName:'',status:'',limitStart:" + pages*per_page_number + ",limitEnd:" + per_page_number + ",roleId:" + roleId;
            <% } %>
            jQuery.AjaxCommon("/ServicesFile/UserService.asmx/GetAgents", data, true, false, function (json) {
                if (json.d != "none") {
                    $("#Pagination").pagination(count1, {
                        num_edge_entries: 2,
                    ...
                    //parent.document.max.location="aa.htm";
                }
...
<body>
<table width="1054" style="height:390px;" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td valign="top" bgcolor="#1C1C1C"><table width="100%" border="0" cellpadding="0" cellspacing="5">
                    <tr>
                      ...
                      <td align="right">
                      账号：<input type="text" id="UserName" style="width:100px;" />
<select id="stateSlt">
...
<input id="selectbutton" type="button" value="查找" />
                ...
                <td height="40" bgcolor="#1C1C1C"><table width="1028" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <table><tr><td>
                        <table width="290" border="0" cellspacing="1" cellpadding="0">
                              <tr>
                                <td width="143" height="30" align="center"  bgcolor="#666666" class="STYLE11" onclick="window.location='loginDetailed.aspx';" style="cursor: pointer;">报表</td>
                                <td width="144" align="center" bgcolor="#FF8D1A" onclick="window.location='Memberlist.aspx';" style="cursor: pointer;"><span class="STYLE12">会员</span></td>
                              </tr>
                                              </table>
                                              </td>
                                  <td><p id="pathP" style="display:none;"><font class="st" id="hyqd"> 会员列表</font><a onmouseover="this.style.cursor=''" ></a></p></td>            
                                              </tr></table>
                                              </td>
                          </tr>
                  ...
                  <tr>
                    <td height="30" align="center" bgcolor="#666666" class="STYLE11">序号</td>
                          <td  align="center" bgcolor="#666666" class="STYLE11">帐号</td>
                          <td  align="center" bgcolor="#666666" class="STYLE11">币种</td>
                          <td  align="center" bgcolor="#666666" class="STYLE11">状态</td>
                          <td align="center" bgcolor="#666666" class="STYLE11">最后登录</td>
                          <td  align="center" bgcolor="#666666" class="STYLE11">IP地址</td>
                        </tr>
                    <tbody id="showInfo">
          ...
          <tr id="tr1">
            <td height="30" align="center" bgcolor="#2A2B2B"></td>
            <td height="30"  id="UID" align="center" bgcolor="#2A2B2B"></td>
            <td id="tdbz" align="center" bgcolor="#2A2B2B"></td>
            <td id="Status" align="center" bgcolor="#2A2B2B"></td>
            <td id="Time" align="center" bgcolor="#2A2B2B"></td>
            <td id="IP" align="center" bgcolor="#2A2B2B"></td>
            </tr>
          </tfoot>
