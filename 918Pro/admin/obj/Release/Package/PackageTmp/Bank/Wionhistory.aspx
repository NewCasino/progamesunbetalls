<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wionhistory.aspx.cs" Inherits="admin.Bank.Wionhistory" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SelectByWhere() {
            $("#tb2>tbody").html("");
            $.AjaxCommon("/ServicesFile/BankService/BankService.asmx/GetWinHistoryByWhere", "userName:'" + $.trim($("#memberSel").val()) + "',name:'" + $.trim($("#memberName").val()) + "',status:'" + $.trim($("#statusSel").val()) + "',time1:'" + $("#time1WhereVal").val() + "',time2:'" + $("#time2WhereVal").val() + "'", true, false, function (json) {
          //  debugger
                if (json.d != "]") {
                    ...
                    html += "<tr><td>总计</td><td colspan='2'></td><td class='red'>" + total1.toFixed(2) + "</td><td colspan='7'></td></tr>";
                    $("#tb2>tbody").html(html);
...
<th width="*" class="tab_top_m"><p id="zdjs">赢币况换查询</p></th>
...
<div id="main">
    ...
    <div  style="width:95%;padding:3px;margin:2px;"><span id="VerifyWithDrawal" class="btn_04"  style=" font-size:11px; display:none" >&nbsp;&nbsp;未审核取款&nbsp;&nbsp;</span>&nbsp;<span id="withdrawalHistory" class="btn_04" style=" color:Yellow; font-size:13px; font-weight:600">&nbsp;&nbsp;已况换赢币&nbsp;&nbsp;</span>&nbsp;&nbsp;
