<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeBehind="BetAccount.aspx.cs" Inherits="Admin.BetAccount" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        SetGlobal("");
            ...
            jQuery.AjaxCommon("/ServicesFile/webBasicInfo/BetaccountService.asmx/getAllCount", data, false, false, function (json) {
            ...
            $("#sure").click(function () {
                ...
                data = "aname:'" + $("#aname").val() + "',casino:'" + $("#addCasino").val() + "',userid:'" + $("#addID").val() + "',password:'" + $("#addPassword").val() + "',";
                ...
                $.AjaxCommon("/ServicesFile/webBasicInfo/BetaccountService.asmx/InsertInfo", data, false, false, function (json) {
                    if (json.d != "none") {
                        if (json.d == "-1") {
        ...
        setLang = $.SetOrGetLanguage(setLang, function () {
                ...
                $("#AddWebInfo>tr:eq(7)").find("td:eq(0)").text(languages["H1061"]);
                ...
                $("#AddWebInfo>tr:eq(8)").find("td:eq(0)").text(languages["H1049"]);
                $("#AddWebInfo>tr:eq(8)").find("td:eq(2)").text(languages["H1065"]);
...
//                $("#tb2>thead>tr>th:eq(14)").text(languages["H1027"]);
        ...
        function setDate(data1) {
            ...
            //alert(data2);
            //return;
            $.AjaxCommon("/ServicesFile/webBasicInfo/BetaccountService.asmx/GetDateAll", data2, false, false, function (json) {
                ...
                //debugger
                    ...
                    $.each(result, function (i) {
                        ...
                        tr.find("#cname").text(result[i].anothername);
                        ...
                        tr.find("#updataInfo").find("#RepeatAdd").click(function () {
                            ...
                            $("#aname").val(result[i].anothername);
                        ...
                        tr.find("#updataInfo").find("#update").click(function () {
                            ...
                            div.find("#aname").val(result[i].anothername);
                            $.AjaxCommon("/ServicesFile/webBasicInfo/WebInfoService.asmx/GetDate", "", true, false, function (json1) {
                                if (json1.d != "none") {
                    ...
                    setLang = $.SetOrGetLanguage(setLang, function () {
                        ...
                        div.find("#trEnd").html("<td align=\"center\" colspan=\"4\"><input type=\"button\" id=\"upda\" class=\"btn_02\" onmouseover=\"this.className='btn_02_h'\" onmouseout=\"this.className='btn_02'\"  value=\""+languages["H1009"]+"\" /><input type=\"button\"  id=\"upEsc\" class=\"btn_02\" onmouseover=\"this.className='btn_02_h'\" onmouseout=\"this.className='btn_02'\" onclick=\"close_list()\" value=\""+languages["H1011"]+"\" /></td></td>");
                            ...
                            div.find("#trEnd").find("#upda").click(function () {
                                ...
                                data = "aname:'" + div.find("#aname").val() + "',id:'" + div.find("#hideID").val() + "',casino:'" + div.find("#addCasino").val() + "',userid:'" + div.find("#addID").val() + "',password:'" + div.find("#addPassword").val() + "',";
                                ...
                                $.AjaxCommon("/ServicesFile/webBasicInfo/BetaccountService.asmx/UpdateInfo", data, false, false, function (json) {
                                    if (json.d != "none") {
                                    }
                                });
                                //debugger
                                data = "casino:'0',dali:'',id:'',enable:'-1',webPoss:'',Company:''";
                                jQuery.AjaxCommon("/ServicesFile/webBasicInfo/BetaccountService.asmx/getAllCount", data, true, false, function (json) {
                                //debugger
                                    count = parseInt(json.d);
                                });
                                if (count % 20 == 0) {
                        ...
                        tr.find("#updataInfo").find("#delete").click(function () {
                            ...
                            jQuery("#btnSure").bind("click", function () {
                                ...
                                $.AjaxCommon("/ServicesFile/webBasicInfo/BetaccountService.asmx/DeleteInfo", data, false, false, function (json1) {
                                    if (json1.d != "none") {
                                        if (json1.d == "True") {
                                            data = "casino:'0',dali:'',id:'',enable:'-1',webPoss:'',Company:''";
                                            jQuery.AjaxCommon("/ServicesFile/webBasicInfo/BetaccountService.asmx/getAllCount", data, false, false, function (json) {
...
<th width="*" class="tab_top_m"><p id="tzzh">网站投注账号</p></th>
...
<td class="tr">别名：</td>
<td><input type="text" id="aname" class="text_01" onmousemove="this.className='text_01_h'" onmouseout="this.className='text_01'" /></td>
</tr>
<tr>
<td class="tr">外来代理：</td>
