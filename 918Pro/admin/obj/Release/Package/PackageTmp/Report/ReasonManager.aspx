<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReasonManager.aspx.cs" Inherits="admin.Report.ReasonManager"%> 
        ...
        $(document).ready(function () {
            ...
            function funDelete(id, the) {
                ...
                $("#btnDeleteSubmit").click(function () {
                    ...
                    var data = "id:'" + id + "'";
                    $.AjaxCommon(url, data, false, false, function (jsonStr) {
