<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatchCancel.aspx.cs" Inherits="admin.Report.MatchCancel" %>
    ...
    .ui-effects-transfer { border: 2px dotted gray; } 
     ...
     <script type="text/javascript">
         ...
         function SetGlobal(setLang) {
             ...
             setLang = $.SetOrGetLanguage(setLang, function () {
                 ...
                 jQuery("#selectByWhere").click(function () {
                     ...
                     var data = "time1:'" + $("#time1WhereVal").val() + "',time2:'" + $("#time2WhereVal").val() + "',language:'" + $("#language").val() + "',status:'0',agentName:'',roleId:''";
                     setData(data);
                 });
         ...
         function setData(data) {
             jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/GetMatchAll", data, false, false, function (json) {
                 ...
                 jQuery.each(result, function (i) {
                     ...
                     if (result[i].league != league) {
                         if (league != "") {
                             $("#showInfo>tr>td").attr("rowspan", "" + count);
                         }
                         league = leagues;
...
<th width="*" class="tab_top_m"><p id="nameP">取消投注历史</p></th>
