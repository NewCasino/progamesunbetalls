<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Betting.aspx.cs" Inherits="admin.User.Betting" %>
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st" id="tz"> 投注：</font><a onmouseover="this.style.cursor='hand'" onclick="getCount1('','2','0')"><span id="sy"> 首页</span></a></p></th>
