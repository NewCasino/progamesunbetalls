<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberList.aspx.cs" Inherits="admin.User.MemberList" %>
        ...
        function setDate(data) {
            ...
            jQuery.AjaxCommon("/ServicesFile/UserService.asmx/GetAgents", data, true, false, function (json) {
                ...
                jQuery(".edit").click(function () {
                    ...
                    $("#txtCol4").val($CurrentObj.parent().parent().find("td:eq(5)").text()=="启用"?"1":"0");
                    ...
                    jQuery("#btnSave").bind("click", function () {
                        ...
                        jQuery.AjaxCommon(url, data, false, false, function (json) {
                            if (json.d) {
                                ...
                                $CurrentObj.parent().parent().find("td:eq(5)").text(jQuery("#txtCol4").val() == "1" ? languages.H1049 : (jQuery("#txtCol4").val() == "0" ? languages.H1050 : languages.H1101));
...
<table width="70%"  border="0" cellpadding="1" cellspacing="1" id="addtb">
  ...
  <tr>
    ...
    <td align="right">合营商代码：</td>
    <td align="left"><input type="text" name="Mobile" id="parentcode" class="text_01 h20" onmouseover="this.className='text_01_h h20'" onmouseout="this.className='text_01 h20'" onblur="IsNullByInfo(this,'err5',languages.H1306);"  /><span id="err5" style="color:Red"></span></td>
  </tr>
  ...
  <tr style="display:none;">
    ...
    <td align="left" id="SetCredit"><input type="text" name="Credit" id="Credit" value="0" class="text_01 h20" onmouseover="this.className='text_01_h h20'" onmouseout="this.className='text_01 h20'" />&nbsp;<span id="err5" style="color:Red"></span><br /><span style="color:#666666"><span id="H1436">上级信用余额</span>:<label id="credity">5000</label></span></td>
    <td align="right"><span id="H1454">最小投注</span>：</td>
    <td align="left"><input type="text" name="ItemMin" id="ItemMin" value="100" class="text_01 h20" onmouseover="this.className='text_01_h h20'" onmouseout="this.className='text_01 h20'" onblur="checkItemMin(this);" />&nbsp;<span id="err6" style="color:Red"></span></td>
  </tr>
  <tr style="display:none;">
    <td align="right"></td>
    <td align="left" id="rCredit"></td>
    <td align="right"><span id="H1455">最大投注</span>：</td>
    <td align="left"><input type="text" name="ItemMax" id="ItemMax" value="1000" class="text_01 h20" onmouseover="this.className='text_01_h h20'" onmouseout="this.className='text_01 h20'" onblur="checkItemMax(this);" />&nbsp;<span id="err7" style="color:Red"></span></td>
  </tr>
  <tr>
    ...
    <td align="left" style="display:none;"><input type="text" name="ItemsMax" id="ItemsMax" value="5000" class="text_01 h20" onmouseover="this.className='text_01_h h20'" onmouseout="this.className='text_01 h20'" onblur="checkItemsMax(this);" />&nbsp;<span id="err8" style="color:Red"></span></td>
  </tr>
  <tr align="center" style="background-color:#CDEAFC">
