<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberCash.aspx.cs" Inherits="admin.User.MemberCash" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        /*----------------设置分公司提成-----------------*/
        function setConfig(){
            jQuery.AjaxCommon("/ServicesFile/UserService.asmx/GetConfigAll", "", false, false, function (json) {
                if (json.d != "none") {
                    var count = 0;
        ...
        /*----------------获得分页-----------------------*/
        function getpage() {
            var data = "moneyType:'0',upUserName:'" + upUserName + "',userName:'" + jQuery("#UserName").val() + "',status:'" + jQuery("#stateSlt").val() + "',roleId:" + roleId;
        ...
        function setDate(data) {
            <% if(searchAc) { %>
            var data = "moneyType:'0',upUserName:'" + upUserName + "',userName:'" + jQuery("#UserName").val() + "',status:'" + jQuery("#stateSlt").val() + "'," + data + ",roleId:" + roleId;
            <% } else { %>
            var data = "moneyType:'0',upUserName:'" + upUserName + "',userName:'',status:''," + data + ",roleId:" + roleId;
            <% } %>
            jQuery("#UserName").val("");
            jQuery.AjaxCommon("/ServicesFile/UserService.asmx/GetAgents", data, true, false, function (json) {
                if (json.d != "none") {
                    ...
                    jQuery.each(result, function (i) {
                        ...
                        <% if(passwordAc) { %>
                        tr.find("#password").html("<img title='修改密码' src='/images/Icon/page_edit.gif' onmouseover=\"this.style.cursor='hand'\" class='pass'>");
                        <% } %>
                        <% if(mdfAc) { %>
                        tr.find("#upda").html("<img title='修改' src='/images/Icon/page_edit.gif' onmouseover=\"this.style.cursor='hand'\" class='edit'>");
                        <% } %>
            ...
            jQuery("#showInfo>tr").find("#upda").find(":button").click(function () {
                ...
                Ahtml += "<input type=\"button\" id=\"AddButton\" onclick=\"savebutton()\" class=\"btn_02\" onmouseover=\"this.className='btn_02_h'\" onmouseout=\"this.className='btn_02'\"  value='" + languages.H1448 + "' />";
...
//                });
                ...
                window.open("http://www.158bet.com/User/Registration.aspx?t=" + upUserName);
                return false;
            }
            else {
        ...
        function surebutton() {
            ...
            if (type[roleId - 2] == "会员") {
                ...
                data = "moneyType:'0',userName:'" + curUserName + "',pass:'" + jQuery("#Password").val() + "',name:'" + jQuery("#Name").val() + "',mobile:'" + jQuery("#Mobile").val() + "',currency:'" + cyy + "',email:'',tel:'" + jQuery("#Tel").val() + "',status:1,companyPercent:" + (100 - zgscomm) / 100 + ",companyCommission:" + CompanyCommission / 100 + ",subCompany:'" + fname + "',subCompanyPercent:" + fcomm / 100 + ",subCompanyCommission:" + SubCompanyCommission / 100 + ",partner:'" + gname + "',partnerPercent:" + gcomm / 100 + ",partnerCommission:" + PartnerCommission / 100 + ",generalAgent:'" + zname + "',generalAgentPercent:" + zcomm / 100 + ",generalAgentCommission:" + GeneralAgentCommission / 100 + ",agent:'" + dname + "',agentPercent:" + dcomm / 100 + ",agentCommission:" + AgentCommission / 100 + ",percent:0,commission:" + userCommission[1] + ",credit:0,upUserName:'" + upUserName + "',upUserID:" + upID + ",upRoleId:" + upRoleId + ",ItemMin:" + jQuery("#ItemMin").val() + ",itemMax:" + jQuery("#ItemMax").val() + ",itemsMax:" + jQuery("#ItemsMax").val() + ",Group:'" + userCommission[0] + "',resetCredit:'0'";

            }
            else {

                url = "/ServicesFile/UserService.asmx/AddAgent";
                data = "currency:'" + cyy + "',moneyType:'0',userName:'" + curUserName + "',pass:'" + jQuery("#Password").val() + "',name:'" + jQuery("#Name").val() + "',mobile:'" + jQuery("#Mobile").val() + "',email:'',tel:'" + jQuery("#Tel").val() + "',status:1,subCompany:'" + fname + "',sCNumber:0,partner:'" + gname + "',pNumber:0,generaAgent:'" + zname + "',gaNumber:0,agents:'" + dname + "',agentsNumber:0,maxUser:1000,roleId:" + roleId + ",roleName:'" + type[roleId - 2] + "',upUserName:'" + upUserName + "',upUserId:" + upID + ",upRoleId:" + upRoleId + ",upRoleName:'" + upRoleName + "',itemMin:" + jQuery("#ItemMin").val() + ",itemMax:" + jQuery("#ItemMax").val() + ",itemsmax:" + jQuery("#ItemsMax").val() + ",percent:" + jQuery("#preTD").find("select:eq(0)").val() + ",credit:0,commissionA:" + jQuery("#commA").find("select:eq(0)").val() + ",commissionB:" + jQuery("#commB").find("select:eq(0)").val() + ",commissionC:" + jQuery("#commC").find("select:eq(0)").val() + ",resetCredit:'0'";
            }
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st" id="hyqd"> 现金会员</font>：<a onmouseover="this.style.cursor='hand'" onclick="getCount1(0,0,'','2','0',0,0,0)"><span id="sy"> 首页</span></a></p></th>
...
<% if (addAc)
   { %>
<div class="fl">
<input type="button" id="addBtn" class="top_add" onmouseover="this.className='top_add_h'" onmouseout="this.className='top_add'"  value="新增分公司" onclick="show_list()" />
</div>
<% } %>
<div class="fr">
&nbsp;</div>
...
<table width="70%"  border="0" cellpadding="1" cellspacing="1" id="addtb">
  ...
  <tr>
    ...
    <td align="left"><input type="password" name="Password" id="Password" onblur="IsNullByInfo(this,'err1',languages.H1306);" class="text_01 h20" onmouseover="this.className='text_01_h h20'" onmouseout="this.className='text_01 h20'" />&nbsp;<span id="err1" style="color:Red"></span></td>
  ...
  <tr align="center" style="background-color:#CDEAFC">
    <td colspan="4"><strong id="H1462">信用/占成/最小 最大值</strong></td>
  </tr>
  <tr>
    <td align="right"><span id="H1451"></span></td>
    <td align="left" id="SetCredit"></td>
  ...
  <tr>
    ...
    <td align="right"><span id="H1456">单场最高投注限额</span>：</td>
    <td align="left"><input type="text" name="ItemsMax" id="ItemsMax" class="text_01 h20" onmouseover="this.className='text_01_h h20'" onmouseout="this.className='text_01 h20'" onblur="checkItemsMax(this);" />&nbsp;<span id="err8" style="color:Red"></span></td>
  </tr>
  <tr align="center" style="background-color:#CDEAFC">
