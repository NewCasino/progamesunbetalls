<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Commission.aspx.cs" Inherits="admin.User.Commission" %>
...
<th width="*" class="tab_top_m"><p id="pathP"><font class="st"> <span id="H1395">佣金</span>：</font><a onmouseover="this.style.cursor='hand'" onclick="getCount1('','2','0')"><span id="H1460"> 首页</span></a></p></th>
