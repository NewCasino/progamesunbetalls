...
function IsPage(number, infoCount, pageInfo, pageWhere, pageInfoWhere) {
    ...
    //第一页
    jQuery("#pageDiv").find("a:eq(0)").unbind("click").click(function () {
    ...
    //最后一页
    jQuery("#pageDiv").find("a").last().unbind("click").click(function () {
    ...
    //上一页
    jQuery("#pageDiv").find("a:eq(1)").unbind("click").click(function () {
        var id = 0;
        var pd1 = 0;
        jQuery.each(jQuery("#pageSpan>a"), function (i) {
            if (jQuery("#pageSpan>a:eq(" + i + ")").attr("class").toString() == "selected") {
    ...
    //下一页
    jQuery("#pageDiv").find("a:eq(" + (jQuery("#pageDiv").find("a").length - 2) + ")").unbind("click").click(function () {
        var id = 0;
        var pd1 = 0;
        jQuery.each(jQuery("#pageSpan>a"), function (i) {
