<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoteOne.aspx.cs" Inherits="admin.Report.NoteOne" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            zhsz();
            data1 = "id=0&roid=" + roid + "&lg=" + jQuery("#language").val();
...
//            IsPage(parseInt(page), count, '20', 'IDex', 'IDexC');
        ...
        function SetGlobal(setLang) {
            setLang = $.SetOrGetLanguage(setLang, function () {
                languages = language;
                jQuery("#nameP").text(languages["会员注单"]);
            ...
            if (roid != 7) {
                ...
                jQuery.ajax({ url: "NoteO.aspx", type: "post", data: data1 + "&" + data.replace(/:/g, '=').replace(/,/g, '&'), success: function (json) {
                    ...
                    for (var i = 0; i < data2.length; i++) {
                        ...
                        tr.find("#teamTD").html("" + a[8] + "&nbsp;" + a[7] + "</br>" + typeList[parseInt(a[0])].substr(2, typeList[parseInt(a[0])].length - 2) + "<br/>" + a[4] + "&nbsp;-VS-&nbsp;" + a[5] + "<br/>" + a[6] + "&nbsp;&nbsp;@&nbsp;&nbsp;" + a[9]);
                        ...
                        tr.find("#agent").html("" + (a[15] * 100) + "%<br/>" + (a[14] * a[15]).toFixed(2) + "<br/>" + (a[12] < 0 ? ((a[14] * a[15]).toString().substr(0, (a[14] * a[15]).toString().indexOf('.') + 3)) : ((a[14] * a[15] * a[12]).toString().substr(0, (a[14] * a[15] * a[12]).toString().indexOf('.') + 3))));
                        tr.find("#zagent").html("" + (a[16] * 100) + "%<br/>" + (a[14] * a[16]).toFixed(2) + "<br/>" + (a[12] < 0 ? ((a[14] * a[16]).toString().substr(0, (a[14] * a[16]).toString().indexOf('.') + 3)) : ((a[14] * a[16] * a[12]).toString().substr(0, (a[14] * a[16] * a[12]).toString().indexOf('.') + 3))));
                        tr.find("#partner").html("" + (a[17] * 100) + "%<br/>" + (a[14] * a[17]).toFixed(2) + "<br/>" + (a[12] < 0 ? ((a[14] * a[17]).toString().substr(0, (a[14] * a[17]).toString().indexOf('.') + 3)) : ((a[14] * a[17] * a[12]).toString().substr(0, (a[14] * a[17] * a[12]).toString().indexOf('.') + 3))));
                        tr.find("#subCompany").html("" + (a[18] * 100) + "%<br/>" + (a[14] * a[18]).toFixed(2) + "<br/>" + (a[12] < 0 ? ((a[14] * a[18]).toString().substr(0, (a[14] * a[18]).toString().indexOf('.') + 3)) : ((a[14] * a[18] * a[12]).toString().substr(0, (a[14] * a[18] * a[12]).toString().indexOf('.') + 3))));
...
<th width="*" class="tab_top_m"><p id="nameP"><span id="zd1">注单</span>&nbsp;&nbsp;&nbsp;&nbsp;<a style="cursor:hand" onclick="d('0','2',this,'0','','2');" id="sy1">首页</a></p></th>
