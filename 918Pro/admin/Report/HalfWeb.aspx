<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="HalfWeb.aspx.cs" Inherits="admin.Report.HalfWeb" %>
    ...
    <script type="text/javascript">
        ...
        function SetGlobal(setLang) {
            setLang = $.SetOrGetLanguage(setLang, function () {
                languages = language;
                jQuery("#nameP").text(languages["半场亚洲盘及大小盘"]);
                ...
                if (json.d != "none") {
                    ...
                    jQuery.each(result, function (i) {
                        ...
                        if (jQuery("#language").val() == "tw") {
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html("<span style='color:blue'>" + (type.length == 1 ? type : type.substr(1)) + "@" + result[i].Handicap + "</span>&nbsp;" + result[i].Score + "<br/>" + typ[result[i].BetType] + "<br/>" + result[i].Homecn + "&nbsp;-VS-&nbsp;" + result[i].Awaycn + "<br/>" + result[i].leaguecn + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html("<span style='color:blue'>" + (type.length == 1 ? type : type.substr(1)) + "@" + result[i].Handicap + "</span>&nbsp;" + result[i].Score + "<br/>" + typ[result[i].BetType] + "<br/>" + result[i].Homeen + "&nbsp;-VS-&nbsp;" + result[i].Awayen + "<br/>" + result[i].leagueen + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html("<span style='color:blue'>" + (type.length == 1 ? type : type.substr(1)) + "@" + result[i].Handicap + "</span>&nbsp;" + result[i].Score + "<br/>" + typ[result[i].BetType] + "<br/>" + result[i].Hometh + "&nbsp;-VS-&nbsp;" + result[i].Awayth + "<br/>" + result[i].leagueth + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
                            ...
                            setLang = $.SetOrGetLanguage(setLang, function () {
                                languages = language;
                                tr.find("#teamTD").html("<span style='color:blue'>" + (type.length == 1 ? type : type.substr(1)) + "@" + result[i].Handicap + "</span>&nbsp;" + result[i].Score + "<br/>" + typ[result[i].BetType] + "<br/>" + result[i].Homevn + "&nbsp;-VS-&nbsp;" + result[i].Awayvn + "<br/>" + result[i].leaguevn + "&nbsp;&nbsp;@&nbsp;&nbsp;" + result[i].BeginTime);
                            }, "/js/IndexGlobal/");
                        }
...
<th width="*" class="tab_top_m"><p id="nameP">半场亚洲盘及大小盘</p></th>
...
<!-- 自动刷新DIV -->
<div class="fr">
<input type="text" id="timeTxt" value="60" class="text_01 w_30" onmouseover="this.className='text_01_h w_30'" onmouseout="this.className='text_01 w_30'" /><label id="timeUp">5</label>&nbsp;&nbsp;&nbsp;&nbsp;
...
<!-- 数据显示TABLE -->
<div id="divExcel">
    <table width="100%" class="tab2" id="tab2">
    <thead>
    <tr align="center">
    <th>时间</th>
    <th>队伍</th>
