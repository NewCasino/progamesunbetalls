<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatchResult.aspx.cs" Inherits="admin.Report.MatchResult" %>
...
/*重点：固定表头样式*/
/*
.scrollColThead {position: relative;top: expression(this.parentElement.parentElement.parentElement.scrollTop);z-index:20;}
.scrollCR { z-index:30;}
...
*/
     ...
     <script type="text/javascript">
         $(function () {
             ...
             function SetGlobal(setLang) {
                 ...
                 setLang = $.SetOrGetLanguage(setLang, function () {
                     ...
                     tr.html("<td height=\"160\" style='border:0px;' colspan=\"20\" ></td>");
                     tr.appendTo("#showInfo");
                     //             tr = jQuery("#total").clone();
                     //             tr.attr("class", "tc");
                     //             tr.find("#name").html("全部");
                     //             tr.appendTo("#showTotalInfo");
                     ...
                     jQuery("#selectByWhere").click(function () {
                         ...
                         var data = "time1:'" + $("#time1WhereVal").val() + "',time2:'" + $("#time2WhereVal").val() + "',language:'" + $("#language").val() + "',status:'1',agentName:'',roleId:'',mtype:'" + jQuery("#mtype").val() + "'";
                         setData(data);
                     });
         ...
         function setData(data) {
             jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/GetMatchAll2", data, true, false, function (json) {
                 jQuery("#showInfo>tr").remove();
                 var result = jQuery.parseJSON(json.d), league = "";
                 var Transfers = 0;
                 ...
                 jQuery.each(result, function (i) {
                     ...
                     if (leagues != league) {
                         ...
                         tr.attr("class", "tl");
                         tr.html("<td align=\"left\" class=\"fb\" colspan=\"20\"  style=\"background-color:#DCF0FD;text-align:left\"><a href='javascript:void(0)' onclick=\"ShowDetail('" + result[i].gameid + "','','','');\"><font color='#333333'>" + league + "</font></a></td>");
                         tr.appendTo("#showInfo");
                     }
                     tr = jQuery("#leagueInfo").clone();
                     tr.attr("class", "tc");
                     var type = Conversion(result[i].BetType);
                     tr.find("#BetType").html("<a href='javascript:void(0)' onclick=\"ShowDetail('" + result[i].gameid + "','" + result[i].BetType + "','','');\"><font color='#333333'>" + type + "</font></a>");
                 ...
                 tr.attr("class", "tl");
                 if (result == "") {
                     tr.html("<td height=\"425\" colspan=\"20\">" + languages.H1413 + "</td>");
                 } else {
                     tr.html("<td height=\"425\" colspan=\"20\"></td>");
                 }
                 tr.appendTo("#showInfo");
                 tr = jQuery("#total");
                 tr.attr("class", "tc");
         ...
         function getUserName(data) {
             jQuery.AjaxCommon("/ServicesFile/ReportWebService.asmx/LeagueOrderDetail2", data, true, false, function (json) {
         ...
         function ShowDetail(gameid, betType, agentName, roleId) {
             ...
             + "',betType:'" + betType + "',agentName:'" + agentName + "',roleId:'" + roleId + "',mtype:'" + jQuery("#mtype").val() + "'";
             getUserName(data);
         }
     </script>
</head>
...
<!-- 数据显示TABLE -->
    ...
    <table id="tb2" width="100%" class="tab2" style="border:0px;">
    <thead>
    <tr align="center">
    ...
    <tbody id="showInfo" style=" height:100%;">
    
    </tbody>
    <tfoot>
        <tr id="total">
    <td id="name" align="center" style="width:10%">全部</td>
    <td id="Transfers" style="width:6%">0.00</td>
    <td id="Commissions" style="width:6%">0.00</td>
    <td id="Members" style="width:70px">0.00</td>
    <td id="MemberCommissions" style="width:70px">0.00</td>
    <td id="MemberResults" style="width:70px">0.00</td>
    <td id="Agents" style="width:70px">0.00</td>
    <td id="AgentCommissions" style="width:70px">0.00</td>
    <td id="AgentResults" style="width:70px">0.00</td>
    <td id="ZAgents" style="width:70px">0.00</td>
    <td id="ZAgentCommissions" style="width:70px">0.00</td>
    <td id="ZAgentResults" style="width:70px">0.00</td>
    <td id="Partners" style="width:70px">0.00</td>
    <td id="PartnerCommissions" style="width:70px">0.00</td>
    <td id="PartnerResults" style="width:70px">0.00</td>
    <td id="SubCompanys" style="width:70px">0.00</td>
    <td id="SubCompanyCommissions" style="width:70px">0.00</td>
    <td id="SubCompanyResults" style="width:70px">0.00</td>
    <td id="CompanyCommissions" style="width:70px">0.00</td>
    <td id="Companys" style="width:70px" class="red">0.00</td>
    </tr>
    ...
    <table>
        <tbody id="showTotalInfo">
        
        </tbody>
        <tfoot>
        <tr id="leaguetr"></tr>
    <tr id="leagueInfo">
    <td id="BetType" class="acss0"></td>
    <td id="Transfer" class="acss1"></td>
    <td id="Commission" class="acss2"></td>
    <td id="Member"></td>
