...
namespace admin.ServicesFile.ReportService
{
    ...
    public class UnrecognizedService : System.Web.Services.WebService
    {
        ...
        public string setUpData(string id, string type, string info, string typeInfo)
        {
            ...
            {
                //List<Orderother> orderother = OrderotherManager.getorderotherAll(int.Parse(idlist[i]));
                //if (orderother.Count > 0) {
                //    var st = OrderotherManager.updateOrderotherStatus(int.Parse(type),int.Parse(idlist[i]));
                //}
                ...
                if (typeInfolist[i] == "走地全场让球")
                {
                    ...
                    hdpl.MemberCommission = live.MemberCommission;
                    hdpl.MemberPercent = live.MemberPercent;
                ...
                else if (typeInfolist[i] == "走地全场大小")
                {
                    ...
                    loul.MemberCommission = live.MemberCommission;
                    loul.MemberPercent = live.MemberPercent;
                ...
                else if (typeInfolist[i] == "走地全场标准")
                {
                    ...
                    lx2l.MemberCommission = live.MemberCommission;
                    lx2l.MemberPercent = live.MemberPercent;
                ...
                else if (typeInfolist[i] == "走地半场让球")
                {
                    ...
                    hdphfl.MemberCommission = live.MemberCommission;
                    hdphfl.MemberPercent = live.MemberPercent;
                ...
                else if (typeInfolist[i] == "走地半场大小")
                {
                    ...
                    louhfl.MemberCommission = live.MemberCommission;
                    louhfl.MemberPercent = live.MemberPercent;
                ...
                else if (typeInfolist[i] == "走地半场标准")
                {
                    ...
                    lx2hfl.MemberCommission = live.MemberCommission;
                    lx2hfl.MemberPercent = live.MemberPercent;
                    Orderdetail1x2hflManager.AddOrderdetail1x2hfl(lx2hfl);
                }

                //设置外调注单
                OrderotherManager.updateOrderotherStatus(Convert.ToInt32(type), live.OrderID);
