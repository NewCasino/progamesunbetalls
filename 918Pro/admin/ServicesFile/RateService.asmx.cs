...
namespace admin.ServicesFile
{
    ...
    public class RateService : System.Web.Services.WebService
    {
        ...
        [WebMethod(true)]
        public string AddRate1(string code, string cn, string tw, string en, string th, string vn, string Rate)
        {
            if (Session[Util.ProjectConfig.ADMINUSER] == null)
            {
                return "";
            ...
            if (reval)
            {
                ...
                rates.Operator = m.ManagerId;
                rates.Ip = addressList[0].ToString();
                return DAL.ObjectToJson.ObjectsToJson<Model.Rate>(rates);
            }
            else
            {
                return "none";
        ...
        [WebMethod(true)]
        public string UpdateRate(string code, string Id, string Name,string uName,string Rate, string Language)
        {
            if (Session[Util.ProjectConfig.ADMINUSER] == null)
            {
                return "";
