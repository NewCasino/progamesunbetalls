<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayResult.aspx.cs" Inherits="_138SUN.YP.PayResult" %>


<%
    String MD5key = "XvBuwJq^";									//MD5加密码(测试用)
...
<!-- 请加上你们网站的框架。就是你们网站的头部top，左部left等。还有字体等你们都要做调整。 -->
 ...
 <!-- MD5验证成功 -->
  ...
  <tr>
    <td  align="right" valign="top" width="200">订单号：</td>
...
<table width="728" border="0" cellspacing="0" cellpadding="0" align="center">
 <tr>
    <td  align="center" valign="top" style="color:red;">支付失败，请联系客服!</td>
	</tr>
	</table>
<%	
}
