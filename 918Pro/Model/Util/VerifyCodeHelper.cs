...
namespace Util
{
    ...
    public class VerifyCodeHelper
    {
        ...
        #region 自定义随机颜色数组
        private Color[] colors = { Color.Black, Color.Red, Color.DarkBlue, Color.Green, Color.Brown, Color.DarkCyan, Color.Purple };
        public Color[] Colors
        {
            get { return colors; }
            set { colors = value; }
        ...
        private string codeSerial = "2,3,4,5,6,7,8,a,b,c,d,e,f,h,k,m,n,p,q,r,s,t,u,v,w,x,y,z,A,B,C,D,E,F,G,H,J,K,L,M,N,P,Q,R,S,T,U,V,W,X,Y,Z";
