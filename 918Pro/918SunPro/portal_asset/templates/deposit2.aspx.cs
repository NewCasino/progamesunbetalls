...
namespace _10sunGameLogin.portal_asset.templates
{
    public partial class deposit2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                OrderDesc = "";
                ReturnURL = "http://paay.igou918.cn/YP/PayResult.aspx";
                AdviceURL = "http://paay.igou918.cn/YP/HCresult.aspx";  // '[必填]支付完成后，后台接收支付结果，可用来更新数据库值
