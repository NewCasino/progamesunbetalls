...
function cs() {
    ...
    var cs = window.open("http://szzero.livechatvalue.com/chat/chatClient/chatbox.jsp?companyID=418814&amp;jid=8064067793&amp;enterurl=http://www.77sunbet.com&amp;pagereferrer=&amp;lan=zh&amp;tm=1393669593713", "livechat", "height=430, width=550, toolbar= no,directions=no,alwaysRaised=yes,hotkeys =yes, menubar=no, scrollbars=no, resizable=no, location=no, status=no,top=100,left=300");
    cs.focus();
}
//


var IMAGESPATH = 'images/index.html'; //图片路径配置
...
Dialog.prototype.displacePath = function () {
    if (this.URL.substr(0, 7) == "http://" || this.URL.substr(0, 1) == "/" || this.URL.substr(0, 11) == "javascript:") {
        ...
        locationPath = locationPath.substring(0, locationPath.lastIndexOf('index.html'));
        while (thisPath.indexOf('index.html') >= 0) {
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      ...
      <td height="33" style="background-image:url(' + IMAGESPATH + 'dialog_ct.png) !important;background: url(' + IMAGESPATH + 'dialog_ct.gif) repeat-x top;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; display:none; color:#fff;"><img align="absmiddle" src="' + IMAGESPATH + 'icon_dialog.png"/><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
       </td>\
      <td width="30" height="30" style="background-image: url(' + IMAGESPATH + 'dialog_rt.png) !important;background: url(' + IMAGESPATH + 'dialog_rt.gif) no-repeat right 0;"><div onclick="Dialog.getInstance(\'' + this.ID + '\').cancelButton.onclick.apply(Dialog.getInstance(\'' + this.ID + '\').cancelButton,[]);" onmouseout="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn.png)\'" onmouseover="this.style.backgroundImage=\'url(' + IMAGESPATH + 'dialog_closebtn.png)\'" style="position: relative; cursor: pointer; float: right; height: 30px; width: 30px; margin-left:-30px; background-image: url(' + IMAGESPATH + 'dialog_closebtn.png);' + (this.ShowCloseButton ? "" : "display:none;") + '"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top">\
